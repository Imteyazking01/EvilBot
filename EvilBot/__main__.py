...
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/KING_FIGHTER_CHAT_bOT?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="𝐀𝐛𝐨𝐮𝐭💝", callback_data="KingFighter_"),
        InlineKeyboardButton(
            text="𝙢𝙮 𝙙𝙚𝙖𝙧𝙚𝙨𝙩 𝙨𝙞𝙨𝙩𝙚𝙧", url=f"https://t.me/Akshita_012"
        ),
     ],
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url="https://t.me/King_fighter_Bot_support"),
        InlineKeyboardButton(text="𝐑𝐞𝐩𝐨🇮🇳", url="https://github.com/Imteyazking01/KING-FIGHTER-CHAT-BOT"),
    ], 
